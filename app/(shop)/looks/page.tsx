  ...
  return (
    <div>
      <div className="border-b border-brand-navy/10 px-4 pt-8 pb-6 md:px-10">
        <p className="font-mono text-xs uppercase tracking-wide text-brand-gold-deep">Complete outfits</p>
        ...
        <p className="mt-2 max-w-lg font-ui text-sm text-brand-navy/55">
          Every piece already styled together — rent the whole look in one line, or open a piece to swap it out.
        </p>
      </div>
      ...
      {outfits.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-px bg-brand-navy/10 p-4 md:grid-cols-2 md:p-10">
